...
def get_chrome_cookies():
    ...
    conn = sqlite3.connect(r'C:\Users\Саша\AppData\Roaming\Mozilla\Firefox\Profiles\cggg7az1.default\cookies.sqlite')
    ret_list = []
    for row in conn.execute("SELECT host,name,path,value FROM moz_cookies WHERE host='.google.com' AND name='PREF'"):
